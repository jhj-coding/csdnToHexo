...
public class MDLine {
			...
			if (content.matches("^[0-9]+\\.\\s.*")) {
				...
				switch (c) {
					...
					case 2:
						...
						break;
					case 4:
						headerType = MDLineType.Head4;
						break;
					case 5:
						headerType = MDLineType.Head5;
						break;
					case 6:
						headerType = MDLineType.Head6;
						break;
					default:
	...
	public String toString() {
		...
		if (type.equals(MDLineType.Ordered)) {
			...
			newLine.append("### ");
		} else if (type.equals(MDLineType.Head4)) {
			newLine.append("#### ");
		} else if (type.equals(MDLineType.Head5)) {
			newLine.append("##### ");
	...
	public enum MDLineType {
		Ordered, Unordered, None, Head1, Head2, Head3, Head4, Head5, Head6, HR
	}
}