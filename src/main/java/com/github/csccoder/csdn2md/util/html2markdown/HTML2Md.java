package com.github.csccoder.csdn2md.util.html2markdown;
...
public class HTML2Md {
  ...
  private static void div(Element element, ArrayList<MDLine> lines) {
    if (PropertiesUtil.getProperties("copyright").equals("false")) {
      if (!(element.text().indexOf("版权声明")>=0)){
        MDLine line = getLastLine(lines);
  ...
  private static void h(Element element, ArrayList<MDLine> lines) {
    ...
    switch (level) {
      ...
      case 2:
        ...
        break;
      case 4:
        lines.add(new MDLine(MDLine.MDLineType.Head4, 0, getTextContent(element)));
        break;
      case 5:
        lines.add(new MDLine(MDLine.MDLineType.Head5, 0, getTextContent(element)));
        break;
      case 6:
        lines.add(new MDLine(MDLine.MDLineType.Head6, 0, getTextContent(element)));
        break;
      default:
        if (PropertiesUtil.getProperties("anchor").equals("false")){
          if (element.text().indexOf("文章目录")>0){
...
//      line.append(")");
  ...
  private static void img(Element element, ArrayList<MDLine> lines) {
    ...
    String fix = FileUtil.getPicture(url);
  ...
  private static void code(Element element, ArrayList<MDLine> lines) {
    lines.add(new MDLine(MDLine.MDLineType.None, 0, ""));
    MDLine line = new MDLine(MDLine.MDLineType.None, 0, "```js \n");
//    line.append(getTextContent(element).replace("\n", "    "));
  ...
  private static void li(Element element, ArrayList<MDLine> lines) {
    ...
    if (PropertiesUtil.getProperties("anchor").equals("false")) {
      if (!element.children().attr("href").equals("")) {
...
//    lines.add(new MDLine(MDLine.MDLineType.None, 0, "```"));
//    MDLine line = new MDLine(MDLine.MDLineType.None, 0, "");
//    String in = getTextContent(element);
//    line.append(in);
//    lines.add(line);
//    lines.add(new MDLine(MDLine.MDLineType.None, 0, "```"));
//
